...
class BasicExecute:
    ...
    def __init__(self, tree, env):
        ...
        if result is not None and isinstance(result, int):
            #print(result)
            self.printaux.append(str(result))
    ...
    #test print
        ...
        if node[0] == 'fun_call':
            try:
                ...
                #self.resultado = "Funcion Indefinida: '%s'" % node[1]
                self.printaux.append("Funcion Indefinida: '%s'" % node[1])
        ...
        if node[0] == 'var':
            try:
                ...
                #self.resultado = "Variable '"+node[1]+"' no declarada"
                self.printaux.append("Variable '"+node[1]+"' indefinida")
